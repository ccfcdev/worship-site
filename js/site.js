...
function boot(){ register(); tabs(); joinForm(); split(); revealAboveFold(); grain(); nav(); reveals(); revealSafety(); hero(); lightbox(); countdown(); capture(); $$('.year').forEach(e => e.textContent = new Date().getFullYear()); }
